  ...
  <p class="panel-heading">
    ...
    <form action="{{ route('perfils.store') }}"  method="post" >
            ...
            <div class="form-group">
                ...
                <input type="text" name="NombrePerfil" id="" size="40">
                </div>
            </div>
<br>
            <div class="form-group">
                <label for="">Nombre:</label>
                <input type="text" name="NombrePersona" id="" size="37">
            </div>
<br>
            <div class="form-group">
                <label for="">Apellido Paterno:</label>
                <input type="text" name="ApellidoPaterno" id="" size="30">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="NumeroTelefono" id="" size="30">
            </div>
